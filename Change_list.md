...
- 2025-12-25: Model, SubmitStudy &  runSubmit have copyConfig methods to allow copying of a configuration 
- 2025-12-28: archive now makes use of copyConfig method which makes it easier to generalise. 
