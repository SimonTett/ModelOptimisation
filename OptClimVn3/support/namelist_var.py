...
type_allowed_fortran = typing.Union[None,int, float, bool, str,list[int],list[float],list[bool],list[str]]  # types allowed in fortran
# None might cause grief but returned by read_value if not found.
