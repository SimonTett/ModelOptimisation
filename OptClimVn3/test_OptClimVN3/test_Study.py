# test code for Study class. Initially generated by chatGPT 29/4/23
# Seeing problem with dumping to disk as config is not being dumped.
import unittest
...
os.environ['OPTCLIMTOP'] = str(pathlib.Path.cwd())
