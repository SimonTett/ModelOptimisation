...
root_pth  ='/BIGDATA2/sysu_atmos_wjliang_1/FG3/ModelOptimisation/OptClimVn3' #liangwj #importlib.resources.files("OptClimVn3")
config =StudyConfig.readConfig(Model.expand("$OPTCLIMTOP/OptClimVn3/configurations/dfols14param_opt3.json")) #liangwj# StudyConfig.readConfig(root_pth/"configurations/dfols14param_opt3.json")
