...
def genProcess(dataset, land_mask, latitude_coord=None):
    ...
    def name_fn(name: str, dataset: xarray.Dataset,*args,name_type=None,**kwargs) -> (xarray.DataArray,None):
        """
...
## deposition rates
        ...
        'Wet_SO2':name_fn("SO2 SCAVENGED BY LS PPN KG/M2/TS",dataset,name_type='long'),
        'Wet_ait':name_fn("SO4 AIT SCAVNGD BY LS PPN KG/M2/TS",dataset,name_type='long'),
        'Wet_acc':name_fn("SO4 ACC SCAVNGD BY LS PPN KG/M2/TS",dataset,name_type='long'),
        'Wet_dis':name_fn("SO4 DIS SCAVNGD BY LS PPN KG/M2/TS",dataset,name_type='long'),
